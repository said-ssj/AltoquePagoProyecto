...
public class ControladorProductos implements Initializable {
    ...
    // --- VARIABLES DE LA TABLA (Únicas, sin duplicar) ---
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Columnas visuales temporales (hasta que agregues categoría/estado a MySQL)
    ...
    private void cargarDatosTabla() {
        if (tablaProductos != null) {
            // Utilizamos el método que ya creaste en ProductoDAO
